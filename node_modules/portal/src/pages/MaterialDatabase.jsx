                            ...
                            <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                                <thead className="bg-slate-50 dark:bg-surface-dark/50">
                                    <tr>
                                        ...
                                        <th className="px-2 py-3 text-right text-xs font-semibold text-slate-500 uppercase tracking-wider w-32">Harga Satuan</th>
                                        <th className="px-2 py-3 text-center text-xs font-semibold text-slate-500 uppercase tracking-wider">Status</th>
                                        <th className="px-2 py-3 text-center text-xs font-semibold text-slate-500 uppercase tracking-wider w-10">Aksi</th>
                                    </tr>
                                </thead>
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-4">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-4">
                                                        <div className="text-sm font-medium text-slate-900 dark:text-white max-w-[200px] lg:max-w-[250px] xl:max-w-xs xl:whitespace-normal truncate" title={item.name}>{item.name}</div>
